  ...
  return (
    <Grid container direction="column">
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src='/assets/reviewIcon.svg' alt='magnifying glass' width='100%' style={{marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
      <Grid item container 
        direction={matchesMD ? 'column':"row"}
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
         <img src='/assets/designIcon.svg' alt='paintbrush leaving stroke paint' width='100%' style={{maxWidth: matchesMD ? 700 :1000, marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src='/assets/buildIcon.svg' alt='construction building site'  width='100%' style={{maxWidth: matchesMD ? 700 : 1000, marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
      <Grid item container 
        direction={matchesMD ? 'column':"row"}
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src='assets/launchIcon.svg' alt='rocket launch' width='100%' style={{maxWidth: 300, maxHeight: 1300}}/>
        </Grid>
      </Grid>
      <Grid item container 
        direction={matchesMD ? 'column':"row"}
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src='/assets/maintainIcon.svg' alt='wrench tightening bolts'width='100%' style={{maxWidth: matchesMD ? 700 : 500, marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
      <Grid item container 
        direction={matchesMD ? 'column':"row"}
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src='/assets/iterateIcon.svg' alt='dominos' width='100%' style={{maxWidth: matchesMD ? 700 : 1000, marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
