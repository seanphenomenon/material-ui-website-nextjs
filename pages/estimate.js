...
export default function Estimate() {
  ...
  return (
    <Grid container direction="row">
      <Head>
        <title key="title">Custom Software Estimate | Arc Development</title>
        <meta
          name="description"
          key="description"
          content="Use our free online estimator to easily check the cost of your custom software, mobile app, or website design and development project!"
        />
        <meta
          property="og:title"
